...
def main():
    ...
    pop = pd.read_csv("Population_Berlin.csv")
    ...
    crime['Total crime trend'] = crime.groupby(['District', 'Location'])['Total crimes'].pct_change()
    crime['Total theft trend'] = crime.groupby(['District', 'Location'])['Theft'].pct_change()
